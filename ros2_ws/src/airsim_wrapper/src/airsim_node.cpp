...
int main(int argc, char** argv)
{
    ...
    nh->get_parameter("enable_world_plot", enable_world_plot);
    airsim_wrapper::AirsimWrapper airsim_wrapper(nh, host_ip, host_port, enable_api_control, enable_world_plot);
